...
{
    [TestClass]
    public class CheckIfCategoryExistsShould
    {

        [TestMethod]
        public void ReturnTrue_WhenTheCategoryExists()
        {
            ...
            var isFound = categoryService.CheckIfCategoryExists("Category1");
        ...
        public void ReturnFalse_WhenTheCategoryExists()
        {
            ...
            var isFound = categoryService.CheckIfCategoryExists("Category2");
